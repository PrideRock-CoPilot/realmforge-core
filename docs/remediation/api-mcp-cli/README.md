# API/MCP/CLI Surfaces — Remediation Planning

**Owner:** Marcus (API Architect)

**Description:**
External interfaces: REST API, Model Context Protocol (MCP) server, and operator CLI. Contract design, versioning, error standards, and thin transport layers.

---

## Contents

This directory contains remediation planning documents for the API/MCP/CLI Surfaces area:

* **REMEDIATION_PLAN.md (TBD)**
* **API_CONTRACTS.md (TBD)**
