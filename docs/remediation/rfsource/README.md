# RFSource Storage Layer — Remediation Planning

**Owner:** Dmitri (Backend)

**Description:**
Custom git-like storage layer with ACID transactions, versioning, and governance. 9 Rust crates providing frame-based storage, commit operations, time-warp rollback, governance policies, indexing, catalog, query, materialization, and service layers.

---

## Contents

This directory contains remediation planning documents for the RFSource Storage Layer area:
