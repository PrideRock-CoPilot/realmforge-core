# Catalog System — Remediation Planning

**Owner:** Chen (Data Architect)

**Description:**
Metadata catalog for all RealmForge resources. Schema management, discovery, lineage tracking, and metadata governance. PostgreSQL-backed persistence.

---

## Contents

This directory contains remediation planning documents for the Catalog System area:

* **REMEDIATION_PLAN.md (TBD)**
* **SCHEMA_DESIGN.md (TBD)**
