# Snapshot Ledger — Remediation Planning

**Owner:** Dmitri (Backend)

**Description:**
Event sourcing and snapshot management. Append-only event log, point-in-time snapshots, state reconstruction, and event replay capabilities.

---

## Contents

This directory contains remediation planning documents for the Snapshot Ledger area:
