# Frontend UI — Remediation Planning

**Owner:** Kai (Frontend)

**Description:**
Rich web UI with accessibility compliance (WCAG 2.1 AA). Component library, authority flows, catalog browsing, and user experience polish.

---

## Contents

This directory contains remediation planning documents for the Frontend UI area:
