...
use rfsource_core::{CommitRecord, SourceArtifact, SourceChunk, RFSourceError};
...
pub fn materialize(
    ...
    let state = rfsource.read_valid_state().map_err(|e| MaterializeError::Store(e.to_string()))?;
