...
define_id!(PacketId);
define_id!(CatalogId);
define_id!(WorkPathId);
define_id!(WorkPathNodeId);
define_id!(KnowledgeId);
define_id!(BoardPlanId);
define_id!(BoardApprovalId);
define_id!(ReleaseId);
define_id!(WatchEventId);
define_id!(ViolationId);
define_id!(CostRecordId);
define_id!(BundleId);
define_id!(RuntimeId);
define_id!(WatchSignalId);
