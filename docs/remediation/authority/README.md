# Authority/Identity Domain — Remediation Planning

**Owner:** Yusuf (Domain Architect)

**Description:**
Core identity and authority management. Bounded context for principals, roles, capabilities, and authority state machines. Pure domain logic with no I/O dependencies.

---

## Contents

This directory contains remediation planning documents for the Authority/Identity Domain area:
