//! MCP tool definitions — the complete list of tools with JSON schemas.
//!
//! This module owns the [`ToolDefinition`] struct and the [`core_tool_definitions`]
//! function that returns the full catalog of MCP tools exposed by RealmForge.
