...
| `28_DESIGN_COUNCIL_SYSTEM.md` | Design Council evidence-driven design research engine (DesignBrief aggregate, state machine, validation rules) | `VN-DESIGN-COUNCIL` |
